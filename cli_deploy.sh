...
sleep 60
ssh -o StrictHostKeyChecking=no $USER@$masterIP "sudo chown $USER:$USER /home/$USER/hostfile; nmap -n -p 80 10.0.$PRE.0/20 | grep 10.0.$PRE | awk '{ print \$5 }' > /home/$USER/hostfile"
